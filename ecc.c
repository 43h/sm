...
int ecc_point_is_zero(ecc_curve *curve, ecc_point *point)
{
...
/* Double in place */
static void ecc_point_double_jacobian(ecc_curve *curve, u64 *X1, u64 *Y1, u64 *Z1)
{
	/* t1 = X, t2 = Y, t3 = Z */
...
static void apply_z(ecc_curve *curve, u64 *X1, u64 *Y1, u64 *Z)
{
...
/* P = (x1, y1) => 2P, (x2, y2) => P' */
static void XYcZ_initial_double(ecc_curve *curve, u64 *X1, u64 *Y1, u64 *X2, u64 *Y2, u64 *initialZ)
{
...
/* Input P = (x1, y1, Z), Q = (x2, y2, Z)
   ...
   or P => P', Q => P + Q
   */
static void XYcZ_add(ecc_curve *curve, u64 *X1, u64 *Y1, u64 *X2, u64 *Y2)
{
 ...
 * or P => P - Q, Q => P + Q
 */
static void XYcZ_addC(ecc_curve *curve, u64 *X1, u64 *Y1, u64 *X2, u64 *Y2)
{
	/* t1 = X1, t2 = Y1, t3 = X2, t4 = Y2 */
	u64 t5[ECC_MAX_DIGITS];
...
void ecc_point_mult(ecc_curve *curve, ecc_point *result, ecc_point *point, u64 *scalar, u64 *initialZ)
{
	/* R0 and R1 */
...
void ecc_point_mult2(ecc_curve *curve, ecc_point *result, ecc_point *g, ecc_point *p, u64 *s, u64 *t)
{
...
void ecc_point_add(ecc_curve *curve, ecc_point *result, ecc_point *left, ecc_point *right)
{
